...
SET STEP ON
SET SYSMENU OFF
PUBLIC lcAppDir,Vgc_almatrab,Vgc_usuario,nres,Vln_romana,Vpn_bascula,Vgn_romana
...
PUBLIC Vgn_bascula,Vgc_CERTIFICACION_INEA, VGC_VERSION,Vcl_conex,VPC_llave 
...
cnControladorArch = FOPEN("fact3.xml")
...
aux=AT("</ds:DigestValue>",cCadena,1)
Vgc_server=SUBSTR(cCadena,1,aux-1)

lcCadena = Vgc_server
 
ALINES(laArray, lcCadena, "<ds:DigestValue>")
...
aux2=AT("</ds:DigestValue>",cCadena,2)
